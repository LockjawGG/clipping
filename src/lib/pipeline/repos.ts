    ...
    async loadTarget(renderId) {
      ...
      return {
        ...
        censor: {
          ...
          captionMode: render.clip.censorCaptionMode as "FULL" | "PARTIAL" | "FIRST" | "CUSTOM",
          audioEnabled: render.clip.censorAudioEnabled,
          audioExemptWordIds: render.clip.censorAudioExemptWordIds,
          audioForceWordIds: render.clip.censorAudioForceWordIds,
          wordOverridesJson: render.clip.censorWordOverridesJson,
          audioMode: render.clip.censorAudioMode as "MUTE" | "BEEP" | "TONE",
    ...
    async load(voiceoverId) {
      ...
      return {
        ...
        censor: {
          ...
          exemptWordIds: vo.clip.censorExemptWordIds,
          forceWordIds: vo.clip.censorForceWordIds,
          audioEnabled: vo.clip.censorAudioEnabled,
          audioExemptWordIds: vo.clip.censorAudioExemptWordIds,
          audioForceWordIds: vo.clip.censorAudioForceWordIds,
          wordOverridesJson: vo.clip.censorWordOverridesJson,
        },
      };
    },
